...
cd "$ROOT/simulations/run.offline_local.9999.01"
...
#cd "$ROOT/simulations/run.rom_local.9999"
#./clean_rom_local_run_outputs.sh
#bash run_rom_local.sh

cd "$ROOT/simulations/run.hrom_local.9999.01"
./clean_hrom_local_run_outputs.sh
bash run_hrom_local.sh

cd "$ROOT/simulations/run.post_hrom_local.9999.01"
...
cd "$ROOT/simulations/run.offline_local_quad.9999.01"
...
#cd "$ROOT/simulations/run.rom_local_quad.9999"
#./clean_rom_local_quad_run_outputs.sh
#bash run_rom_local_quad.sh

cd "$ROOT/simulations/run.hrom_local_quad.9999.01"
./clean_hrom_local_quad_run_outputs.sh
bash run_hrom_local_quad.sh

cd "$ROOT/simulations/run.post_hrom_local_quad.9999.01"
